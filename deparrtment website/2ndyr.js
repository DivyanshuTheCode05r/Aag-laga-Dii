...
let students = JSON.parse(localStorage.getItem('itSecondYear')) || [];
...
function addStudent() {
  ...
  localStorage.setItem('itSecondYear', JSON.stringify(students));
  rollNoInput.value = '';
...
function clearAll() {
  if (confirm('Clear all 2nd year data?')) {
    students = [];
    localStorage.removeItem('itSecondYear');
    displayStudents();
  }
}
